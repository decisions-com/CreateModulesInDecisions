...
namespace ModuleBuilder472
{
    [AutoRegisterMethodsOnClass(true, "Integration/Module Builder")]
    public class ModuleBuilder472Class
    {
        ...
        public static string Runner(string requiredModuleName)
        {
            ...
            //find file 
            if (currentpath + @"/UpdateThirdPartyReferencesInModuleBuild.exe" != @"C:\Program Files\Decisions\Decisions Services Manager/UpdateThirdPartyReferencesInModuleBuild.exe")
            {
                System.IO.File.Copy(currentpath + @"/UpdateThirdPartyReferencesInModuleBuild.exe", ModuleFolder + "/UpdateThirdPartyReferencesInModuleBuild.exe", true);
            }
            else
            {
                //this means its in Decisions
                //CreateModulesInDecisions\ServicesDlls
                System.IO.File.Copy(currentpath + @"/modules/CreateModulesInDecisions\ServicesDlls" + @"/UpdateThirdPartyReferencesInModuleBuild.exe", ModuleFolder + "/UpdateThirdPartyReferencesInModuleBuild.exe", true);
